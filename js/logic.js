...
async function loadStatistikDashboard() {
    try {
        ...
        // KRITIS: Tambahkan elemen untuk Rata-rata IPK
        const rataRataIPKEl = document.querySelector('.stat-card:nth-child(4) .stat-value'); // <--- ELEMEN BARU
        
        // Ambil Data dari data-service.js
        ...
        // KRITIS: Panggil fungsi hitung IPK yang baru
        const rataRataIPK = await dataService.hitungRataRataIPK(); // <--- FUNGSI BARU
        ...
        // KRITIS: Tampilkan rata-rata IPK dan bulatkan menjadi 2 desimal
        if(rataRataIPKEl) rataRataIPKEl.textContent = rataRataIPK.toFixed(2); 
